...
(check-exn exn? (lambda () (eval-ast (and-ast (bool-ast #t) (bool-ast #t)) e '())) "and-ast-test: eval-ast can't parse and-ast")
(check-exn exn? (lambda () (eval-ast (cond-ast (list (clause (bool-ast #t) (num-ast 5)))) e '())) "cond-ast-test: eval-ast can't parse cond-ast")
(check-exn exn? (lambda () (eval-ast (new-ref-ast 5))) "num-ast takes in only an ast")
(check-exn exn? (lambda () (deref-ast 5)) "deref-ast takes in only an id-ref-ast")
(check-exn exn? (lambda () (deref-ast (num-ast 5))) "deref-ast takes in only an id-ref-ast")
(check-exn exn? (lambda () (setref-ast (num-ast 5) (num-ast 6))) "setref-ast's first argument should be an id-ref-ast")
